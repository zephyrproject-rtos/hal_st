...
/**
  * @defgroup    MIS2DU12_Interfaces_Functions
...
/**
  ...
  *
  */
int32_t __weak mis2du12_read_reg(const stmdev_ctx_t *ctx, uint8_t reg, uint8_t *data,
                                 uint16_t len)
{
  int32_t ret;
...
/**
  ...
  *
  */
int32_t __weak mis2du12_write_reg(const stmdev_ctx_t *ctx, uint8_t reg, uint8_t *data,
                                  uint16_t len)
{
  int32_t ret;
...
/**
  * @defgroup  MIS2DU12_Private_functions
...
/**
  * @defgroup    MIS2DU12_Sensitivity
  * @brief       These functions convert raw-data into engineering units.
  * @{
  *
  */

float_t mis2du12_from_fs2g_to_mg(int16_t lsb)
{
  return (float_t)lsb * 0.061f;
}

float_t mis2du12_from_fs4g_to_mg(int16_t lsb)
{
  return (float_t)lsb * 0.122f;
}

float_t mis2du12_from_fs8g_to_mg(int16_t lsb)
{
  return (float_t)lsb * 0.244f;
}

float_t mis2du12_from_fs16g_to_mg(int16_t lsb)
{
  return (float_t)lsb * 0.488f;
}

float_t mis2du12_from_lsb_to_celsius(int16_t lsb)
{
...
/**
  ...
  *
  */
int32_t mis2du12_id_get(const stmdev_ctx_t *ctx, mis2du12_id_t *val)
{
  uint8_t reg;
  int32_t ret;

  ret = mis2du12_read_reg(ctx, MIS2DU12_WHO_AM_I, &reg, 1);
...
/**
  ...
  *
  */
int32_t mis2du12_bus_mode_set(const stmdev_ctx_t *ctx, mis2du12_bus_mode_t val)
{
  mis2du12_if_ctrl_t if_ctrl;
  mis2du12_ctrl1_t ctrl1;
  int32_t ret;

  ret = mis2du12_read_reg(ctx, MIS2DU12_IF_CTRL, (uint8_t *)&if_ctrl, 1);
  if (ret == 0)
  {
    if_ctrl.i3c_disable = (uint8_t)val & 0x01U;
    if_ctrl.i2c_disable = ((uint8_t)val & 0x02U) >> 1;
    ret = mis2du12_write_reg(ctx, MIS2DU12_IF_CTRL, (uint8_t *)&if_ctrl, 1);
  }
  if (ret == 0)
  {
    ret = mis2du12_read_reg(ctx, MIS2DU12_CTRL1, (uint8_t *)&ctrl1, 1);
  }
  if (ret == 0)
  {
    ctrl1.sim = ((uint8_t)val & 0x04U) >> 2;
    ret = mis2du12_write_reg(ctx, MIS2DU12_CTRL1, (uint8_t *)&ctrl1, 1);
  }
...
/**
  ...
  *
  */
int32_t mis2du12_bus_mode_get(const stmdev_ctx_t *ctx, mis2du12_bus_mode_t *val)
{
  mis2du12_if_ctrl_t if_ctrl;
  mis2du12_ctrl1_t ctrl1;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t mis2du12_init_set(const stmdev_ctx_t *ctx, mis2du12_init_t val)
{
  mis2du12_ctrl1_t ctrl1;
  mis2du12_ctrl4_t ctrl4;
  int32_t ret;

  ret = mis2du12_read_reg(ctx, MIS2DU12_CTRL1, (uint8_t *)&ctrl1, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_CTRL4, (uint8_t *)&ctrl4, 1);
  ...
  switch (val)
  {
    case MIS2DU12_BOOT:
      ...
      ret = mis2du12_write_reg(ctx, MIS2DU12_CTRL4, (uint8_t *)&ctrl4, 1);
      break;
    case MIS2DU12_RESET:
...
/**
  ...
  *
  */
int32_t mis2du12_status_get(const stmdev_ctx_t *ctx, mis2du12_status_t *val)
{
  mis2du12_status_register_t status_register;
  mis2du12_ctrl1_t ctrl1;
  mis2du12_ctrl4_t ctrl4;
  int32_t ret;

  ret = mis2du12_read_reg(ctx, MIS2DU12_STATUS,
...
/**
  ...
  *
  */
int32_t mis2du12_pin_conf_set(const stmdev_ctx_t *ctx, mis2du12_pin_conf_t *val)
{
  mis2du12_if_pu_ctrl_t if_pu_ctrl;
  mis2du12_md2_cfg_t md2_cfg;
  mis2du12_if_ctrl_t if_ctrl;
  mis2du12_ctrl1_t ctrl1;
  int32_t ret;

  ret = mis2du12_read_reg(ctx, MIS2DU12_IF_PU_CTRL, (uint8_t *)&if_pu_ctrl, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_IF_CTRL, (uint8_t *)&if_ctrl, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_CTRL1, (uint8_t *)&ctrl1, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_MD2_CFG, (uint8_t *)&md2_cfg, 1);
  ...
  ret = mis2du12_write_reg(ctx, MIS2DU12_IF_PU_CTRL, (uint8_t *)&if_pu_ctrl, 1);
  ...
  ret = mis2du12_write_reg(ctx, MIS2DU12_MD2_CFG, (uint8_t *)&md2_cfg, 1);
...
/**
  ...
  *
  */
int32_t mis2du12_pin_conf_get(const stmdev_ctx_t *ctx, mis2du12_pin_conf_t *val)
{
  mis2du12_if_pu_ctrl_t if_pu_ctrl;
  mis2du12_md2_cfg_t md2_cfg;
  mis2du12_if_ctrl_t if_ctrl;
...
/**
  ...
  *
  */
int32_t mis2du12_all_sources_get(const stmdev_ctx_t *ctx,
                                 mis2du12_all_sources_t *val)
{
  mis2du12_all_int_src_t all_int_src;
  int32_t ret;

  ret = mis2du12_read_reg(ctx, MIS2DU12_ALL_INT_SRC, (uint8_t *)&all_int_src, 1);
  if (ret == 0 && all_int_src.int_global == 1U)
  {
    ...
    {
      mis2du12_sixd_src_t sixd_src;

      ret = mis2du12_read_reg(ctx, MIS2DU12_SIXD_SRC, (uint8_t *)&sixd_src, 1);
    ...
    {
      mis2du12_wake_up_src_t wu_src;

      ret = mis2du12_read_reg(ctx, MIS2DU12_WAKE_UP_SRC, (uint8_t *)&wu_src, 1);
    ...
    {
      mis2du12_tap_src_t tap_src;

      ret = mis2du12_read_reg(ctx, MIS2DU12_TAP_SRC, (uint8_t *)&tap_src, 1);
...
/**
  ...
  *
  */
int32_t mis2du12_mode_set(const stmdev_ctx_t *ctx, mis2du12_md_t *val)
{
  mis2du12_ctrl5_t ctrl5;
  int32_t ret;

  ret = mis2du12_read_reg(ctx, MIS2DU12_CTRL5, (uint8_t *)&ctrl5, 1);
  ...
  ret += mis2du12_write_reg(ctx, MIS2DU12_CTRL5, (uint8_t *)&ctrl5, 1);
...
/**
  ...
  *
  */
int32_t mis2du12_mode_get(const stmdev_ctx_t *ctx, mis2du12_md_t *val)
{
  mis2du12_ctrl5_t ctrl5;
  int32_t ret;
  ...
  {
    case 0x00:
      val->odr = MIS2DU12_OFF;
      break;
    case 0x01:
      val->odr = MIS2DU12_1Hz6_ULP;
      break;
    case 0x02:
      val->odr = MIS2DU12_3Hz_ULP;
      break;
    case 0x03:
      val->odr = MIS2DU12_6Hz_ULP;
      break;
    case 0x04:
      val->odr = MIS2DU12_6Hz;
      break;
    case 0x05:
      val->odr = MIS2DU12_12Hz5;
      break;
    case 0x06:
      val->odr = MIS2DU12_25Hz;
      break;
    case 0x07:
      val->odr = MIS2DU12_50Hz;
      break;
    case 0x08:
      val->odr = MIS2DU12_100Hz;
      break;
    case 0x09:
      val->odr = MIS2DU12_200Hz;
      break;
    case 0x0A:
      val->odr = MIS2DU12_400Hz;
      break;
    case 0x0B:
      val->odr = MIS2DU12_800Hz;
      break;
    case 0x0E:
      val->odr = MIS2DU12_TRIG_PIN;
      break;
    case 0x0F:
      val->odr = MIS2DU12_TRIG_SW;
      break;
    default:
      val->odr = MIS2DU12_OFF;
      break;
  ...
  {
    case 0x00:
      val->bw = MIS2DU12_ODR_div_2;
      break;
    case 0x01:
      val->bw = MIS2DU12_ODR_div_4;
      break;
    case 0x02:
      val->bw = MIS2DU12_ODR_div_8;
      break;
    case 0x03:
      val->bw = MIS2DU12_ODR_div_16;
      break;
    default:
      val->bw = MIS2DU12_ODR_div_2;
      break;
...
/**
  ...
  *
  */
int32_t mis2du12_trigger_sw(const stmdev_ctx_t *ctx, mis2du12_md_t *md)
{
  mis2du12_ctrl4_t ctrl4;
  int32_t ret = 0;

  if (md->odr == MIS2DU12_TRIG_SW)
  {
    ret = mis2du12_read_reg(ctx, MIS2DU12_CTRL4, (uint8_t *)&ctrl4, 1);
...
/**
  ...
  *
  */
int32_t mis2du12_data_get(const stmdev_ctx_t *ctx, mis2du12_md_t *md,
                          mis2du12_data_t *data)
{
  ...
  ret = mis2du12_read_reg(ctx, MIS2DU12_OUTX_L, (uint8_t *)&buff, 8);
  ...
  for (i = 0U; i < 3U; i++)
  {
    ...
    {
      case MIS2DU12_2g:
        data->xl.mg[i] = mis2du12_from_fs2g_to_mg(data->xl.raw[i]);
        break;
      case MIS2DU12_4g:
        data->xl.mg[i] = mis2du12_from_fs4g_to_mg(data->xl.raw[i]);
        break;
      case MIS2DU12_8g:
        data->xl.mg[i] = mis2du12_from_fs8g_to_mg(data->xl.raw[i]);
        break;
      case MIS2DU12_16g:
        data->xl.mg[i] = mis2du12_from_fs16g_to_mg(data->xl.raw[i]);
        break;
      default:
        data->xl.mg[i] = 0.0f;
        break;
  ...
  data->heat.deg_c = mis2du12_from_lsb_to_celsius(data->heat.raw);
...
/**
  ...
  *
  */
int32_t mis2du12_self_test_sign_set(const stmdev_ctx_t *ctx, mis2du12_st_t val)
{
  mis2du12_st_sign_t st_sign;
  int32_t ret;

  ret = mis2du12_read_reg(ctx, MIS2DU12_ST_SIGN, (uint8_t *)&st_sign, 1);
  if (ret == 0)
  {
    st_sign.stsign = (uint8_t) val;
    ret = mis2du12_write_reg(ctx, MIS2DU12_ST_SIGN, (uint8_t *)&st_sign, 1);
  }
  return ret;
}
...
/**
  ...
  *
  */
int32_t mis2du12_self_test_start(const stmdev_ctx_t *ctx, uint8_t val)
{
  mis2du12_ctrl3_t ctrl3;
  int32_t ret;
  ...
  ret = mis2du12_read_reg(ctx, MIS2DU12_CTRL3, (uint8_t *)&ctrl3, 1);

  if (ret == 0)
  {
    ctrl3.st = (uint8_t) val;
    ret = mis2du12_write_reg(ctx, MIS2DU12_CTRL3, (uint8_t *)&ctrl3, 1);
  }
...
/**
  ...
  *
  */
int32_t mis2du12_self_test_stop(const stmdev_ctx_t *ctx)
{
  mis2du12_ctrl3_t ctrl3;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t mis2du12_fifo_mode_set(const stmdev_ctx_t *ctx, mis2du12_fifo_md_t *val)
{
  mis2du12_fifo_ctrl_t fifo_ctrl;
  mis2du12_fifo_wtm_t fifo_wtm;
  uint8_t reg[2];
  int32_t ret;

  ret = mis2du12_read_reg(ctx, MIS2DU12_FIFO_CTRL, reg, 2);
  ...
  ret += mis2du12_write_reg(ctx, MIS2DU12_FIFO_CTRL, reg, 2);
...
/**
  ...
  *
  */
int32_t mis2du12_fifo_mode_get(const stmdev_ctx_t *ctx, mis2du12_fifo_md_t *val)
{
  mis2du12_fifo_ctrl_t fifo_ctrl;
  mis2du12_fifo_wtm_t fifo_wtm;
  uint8_t reg[2];
  ...
  {
    case 0x00:
      val->operation = MIS2DU12_BYPASS;
      break;
    case 0x01:
      val->operation = MIS2DU12_FIFO;
      break;
    case 0x06:
      val->operation = MIS2DU12_STREAM;
      break;
    case 0x03:
      val->operation = MIS2DU12_STREAM_TO_FIFO;
      break;
    case 0x04:
      val->operation = MIS2DU12_BYPASS_TO_STREAM;
      break;
    case 0x07:
      val->operation = MIS2DU12_BYPASS_TO_FIFO;
      break;
    default:
      val->operation = MIS2DU12_BYPASS;
      break;
  ...
  {
    case 0x01:
      val->store = MIS2DU12_16_BIT;
      break;
    case 0x00:
      val->store = MIS2DU12_8_BIT;
      break;
    default:
      val->store = MIS2DU12_16_BIT;
      break;
...
int32_t mis2du12_fifo_status_get(const stmdev_ctx_t *ctx, mis2du12_fifo_status_t *val)
{
  mis2du12_fifo_status1_t fifo_status1;
  int32_t ret;

  ret = mis2du12_read_reg(ctx, MIS2DU12_FIFO_STATUS1, (uint8_t *)&fifo_status1, 1);
...
/**
  ...
  *
  */
int32_t mis2du12_fifo_level_get(const stmdev_ctx_t *ctx, mis2du12_fifo_md_t *md,
                                uint8_t *val)
{
  mis2du12_fifo_status2_t fifo_status2;
  int32_t ret;

  ret = mis2du12_read_reg(ctx, MIS2DU12_FIFO_STATUS2,
...
/**
  ...
  *
  */
int32_t mis2du12_fifo_data_get(const stmdev_ctx_t *ctx, mis2du12_md_t *md,
                               mis2du12_fifo_md_t *fmd,
                               mis2du12_fifo_data_t *data)
{
  uint8_t fifo_data[8];
  int8_t i;
  int32_t ret;

  ret = mis2du12_read_reg(ctx, MIS2DU12_OUTX_L, fifo_data, 8);
  ...
  for (i = 0; i < 3; i++)
  {
    ...
    {
      case MIS2DU12_2g:
        data->xl[0].mg[i] = mis2du12_from_fs2g_to_mg(data->xl[0].raw[i]);
        data->xl[1].mg[i] = mis2du12_from_fs2g_to_mg(data->xl[1].raw[i]);
        break;
      case MIS2DU12_4g:
        data->xl[0].mg[i] = mis2du12_from_fs4g_to_mg(data->xl[0].raw[i]);
        data->xl[1].mg[i] = mis2du12_from_fs4g_to_mg(data->xl[1].raw[i]);
        break;
      case MIS2DU12_8g:
        data->xl[0].mg[i] = mis2du12_from_fs8g_to_mg(data->xl[0].raw[i]);
        data->xl[1].mg[i] = mis2du12_from_fs8g_to_mg(data->xl[1].raw[i]);
        break;
      case MIS2DU12_16g:
        data->xl[0].mg[i] = mis2du12_from_fs16g_to_mg(data->xl[0].raw[i]);
        data->xl[1].mg[i] = mis2du12_from_fs16g_to_mg(data->xl[1].raw[i]);
        break;
      default:
        data->xl[0].mg[i] = 0.0f;
        data->xl[1].mg[i] = 0.0f;
...
/**
  ...
  *
  */
int32_t mis2du12_interrupt_mode_set(const stmdev_ctx_t *ctx,
                                    mis2du12_int_mode_t *val)
{
  mis2du12_interrupt_cfg_t interrupt_cfg;
  mis2du12_ctrl1_t ctrl1;
  int32_t ret;

  ret = mis2du12_read_reg(ctx, MIS2DU12_INTERRUPT_CFG,
  ...
  ret = mis2du12_write_reg(ctx, MIS2DU12_INTERRUPT_CFG,
                           (uint8_t *)&interrupt_cfg, 1);
  ret += mis2du12_write_reg(ctx, MIS2DU12_CTRL1, (uint8_t *)&ctrl1, 1);
...
/**
  ...
  *
  */
int32_t mis2du12_interrupt_mode_get(const stmdev_ctx_t *ctx,
                                    mis2du12_int_mode_t *val)
{
  mis2du12_interrupt_cfg_t interrupt_cfg;
  mis2du12_ctrl1_t ctrl1;
  ...
  {
    case 0x00:
      val->base_sig = MIS2DU12_INT_LEVEL;
      break;
    case 0x03:
      val->base_sig = MIS2DU12_INT_LATCHED;
      break;
    default:
      val->base_sig = MIS2DU12_INT_LEVEL;
      break;
...
/**
  ...
  *
  */
int32_t mis2du12_pin_int1_route_set(const stmdev_ctx_t *ctx,
                                    mis2du12_pin_int_route_t *val)
{
  mis2du12_interrupt_cfg_t interrupt_cfg;
  mis2du12_md1_cfg_t md1_cfg;
  mis2du12_ctrl2_t ctrl2;
  int32_t ret;

  ret = mis2du12_read_reg(ctx, MIS2DU12_INTERRUPT_CFG,
                          (uint8_t *)&interrupt_cfg, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_MD1_CFG, (uint8_t *)&md1_cfg, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_CTRL2, (uint8_t *)&ctrl2, 1);
  ...
  ret = mis2du12_write_reg(ctx, MIS2DU12_INTERRUPT_CFG,
                           (uint8_t *)&interrupt_cfg, 1);
  ret += mis2du12_write_reg(ctx, MIS2DU12_MD1_CFG, (uint8_t *)&md1_cfg, 1);
  ret += mis2du12_write_reg(ctx, MIS2DU12_CTRL2, (uint8_t *)&ctrl2, 1);
...
/**
  ...
  *
  */
int32_t mis2du12_pin_int1_route_get(const stmdev_ctx_t *ctx,
                                    mis2du12_pin_int_route_t *val)
{
  mis2du12_interrupt_cfg_t interrupt_cfg;
  mis2du12_md1_cfg_t md1_cfg;
...
/**
  ...
  *
  */
int32_t mis2du12_pin_int2_route_set(const stmdev_ctx_t *ctx,
                                    mis2du12_pin_int_route_t *val)
{
  mis2du12_interrupt_cfg_t interrupt_cfg;
  mis2du12_md2_cfg_t md2_cfg;
...
/**
  ...
  *
  */
int32_t mis2du12_pin_int2_route_get(const stmdev_ctx_t *ctx,
                                    mis2du12_pin_int_route_t *val)
{
  mis2du12_interrupt_cfg_t interrupt_cfg;
  mis2du12_md2_cfg_t md2_cfg;
...
/**
  ...
  *
  */
int32_t mis2du12_wake_up_mode_set(const stmdev_ctx_t *ctx, mis2du12_wkup_md_t *val)
{
  mis2du12_interrupt_cfg_t interrupt_cfg;
  mis2du12_wake_up_ths_t wake_up_ths;
  mis2du12_wake_up_dur_t wake_up_dur;
  mis2du12_md1_cfg_t md1_cfg;
  mis2du12_ctrl1_t ctrl1;
  mis2du12_ctrl4_t ctrl4;
  int32_t ret;
  ...
  ret = mis2du12_read_reg(ctx, MIS2DU12_INTERRUPT_CFG,
                          (uint8_t *)&interrupt_cfg, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_WAKE_UP_THS,
                           (uint8_t *)&wake_up_ths, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_WAKE_UP_DUR,
  ...
  ret += mis2du12_write_reg(ctx, MIS2DU12_INTERRUPT_CFG,
                            (uint8_t *)&interrupt_cfg, 1);
  ret += mis2du12_write_reg(ctx, MIS2DU12_WAKE_UP_THS,
                            (uint8_t *)&wake_up_ths, 1);
  ret += mis2du12_write_reg(ctx, MIS2DU12_WAKE_UP_DUR,
                            (uint8_t *)&wake_up_dur, 1);
  ret += mis2du12_write_reg(ctx, MIS2DU12_MD1_CFG, (uint8_t *)&md1_cfg, 1);
  ret += mis2du12_write_reg(ctx, MIS2DU12_CTRL1, (uint8_t *)&ctrl1, 1);
  ret += mis2du12_write_reg(ctx, MIS2DU12_CTRL4, (uint8_t *)&ctrl4, 1);
...
/**
  ...
  *
  */
int32_t mis2du12_wake_up_mode_get(const stmdev_ctx_t *ctx, mis2du12_wkup_md_t *val)
{
  mis2du12_interrupt_cfg_t interrupt_cfg;
  mis2du12_wake_up_ths_t wake_up_ths;
  mis2du12_wake_up_dur_t wake_up_dur;
  ...
  {
    case 0:
      val->duration = (md1_cfg.wu_dur_x4 == PROPERTY_ENABLE) ? MIS2DU12_WAKE_DUR_3_ODR :
                      MIS2DU12_WAKE_DUR_0_ODR;
      break;
    case 1:
      val->duration = (md1_cfg.wu_dur_x4 == PROPERTY_ENABLE) ? MIS2DU12_WAKE_DUR_7_ODR :
                      MIS2DU12_WAKE_DUR_1_ODR;
      break;
    case 2:
      val->duration = (md1_cfg.wu_dur_x4 == PROPERTY_ENABLE) ? MIS2DU12_WAKE_DUR_11_ODR :
                      MIS2DU12_WAKE_DUR_2_ODR;
      break;
    case 3:
      val->duration = (md1_cfg.wu_dur_x4 == PROPERTY_ENABLE) ? MIS2DU12_WAKE_DUR_15_ODR :
                      MIS2DU12_WAKE_DUR_3_ODR;
      break;
    default:
      val->duration = (md1_cfg.wu_dur_x4 == PROPERTY_ENABLE) ? MIS2DU12_WAKE_DUR_3_ODR :
                      MIS2DU12_WAKE_DUR_0_ODR;
  ...
  {
    case 0x00:
      val->sleep.odr = MIS2DU12_DO_NOT_CHANGE;
      break;
    case 0x03:
      val->sleep.odr = MIS2DU12_SLEEP_AT_6Hz;
      break;
    case 0x02:
      val->sleep.odr = MIS2DU12_SLEEP_AT_3Hz;
      break;
    case 0x01:
      val->sleep.odr = MIS2DU12_SLEEP_AT_1Hz6;
      break;
    default:
      val->sleep.odr = MIS2DU12_DO_NOT_CHANGE;
      break;
...
/**
  ...
  *
  */
int32_t mis2du12_tap_mode_set(const stmdev_ctx_t *ctx, mis2du12_tap_md_t *val)
{
  mis2du12_wake_up_ths_t wake_up_ths;
  mis2du12_tap_ths_x_t tap_ths_x;
  mis2du12_tap_ths_y_t tap_ths_y;
  mis2du12_tap_ths_z_t tap_ths_z;
  mis2du12_int_dur_t int_dur;
  int32_t ret;

  ret = mis2du12_read_reg(ctx, MIS2DU12_WAKE_UP_THS,
                          (uint8_t *)&wake_up_ths, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_TAP_THS_X,
                           (uint8_t *)&tap_ths_x, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_TAP_THS_Y, (uint8_t *)&tap_ths_y, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_TAP_THS_Z, (uint8_t *)&tap_ths_z, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_INT_DUR, (uint8_t *)&int_dur, 1);
  ...
  ret += mis2du12_write_reg(ctx, MIS2DU12_WAKE_UP_THS,
                            (uint8_t *)&wake_up_ths, 1);
  ret += mis2du12_write_reg(ctx, MIS2DU12_TAP_THS_X, (uint8_t *)&tap_ths_x, 1);
  ret += mis2du12_write_reg(ctx, MIS2DU12_TAP_THS_Y, (uint8_t *)&tap_ths_y, 1);
  ret += mis2du12_write_reg(ctx, MIS2DU12_TAP_THS_Z, (uint8_t *)&tap_ths_z, 1);
  ret += mis2du12_write_reg(ctx, MIS2DU12_INT_DUR, (uint8_t *)&int_dur, 1);
...
/**
  ...
  *
  */
int32_t mis2du12_tap_mode_get(const stmdev_ctx_t *ctx, mis2du12_tap_md_t *val)
{
  mis2du12_wake_up_ths_t wake_up_ths;
  mis2du12_tap_ths_x_t tap_ths_x;
  mis2du12_tap_ths_y_t tap_ths_y;
  ...
  ret = mis2du12_read_reg(ctx, MIS2DU12_WAKE_UP_THS,
                          (uint8_t *)&wake_up_ths, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_TAP_THS_X, (uint8_t *)&tap_ths_x, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_TAP_THS_Y, (uint8_t *)&tap_ths_y, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_TAP_THS_Z, (uint8_t *)&tap_ths_z, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_INT_DUR, (uint8_t *)&int_dur, 1);
  ...
  {
    case 0x00:
      val->priority = MIS2DU12_XYZ;
      break;
    case 0x01:
      val->priority = MIS2DU12_YXZ;
      break;
    case 0x02:
      val->priority = MIS2DU12_XZY;
      break;
    case 0x03:
      val->priority = MIS2DU12_ZYX;
      break;
    case 0x04:
      val->priority = MIS2DU12_XYZ;
      break;
    case 0x05:
      val->priority = MIS2DU12_YZX;
      break;
    case 0x06:
      val->priority = MIS2DU12_ZXY;
      break;
    case 0x07:
      val->priority = MIS2DU12_ZYX;
      break;
...
/**
  ...
  *
  */
int32_t mis2du12_free_fall_mode_set(const stmdev_ctx_t *ctx, mis2du12_ff_md_t *val)
{
  mis2du12_wake_up_dur_t wake_up_dur;
  mis2du12_free_fall_t free_fall;
  int32_t ret;

  ret = mis2du12_read_reg(ctx, MIS2DU12_WAKE_UP_DUR,
                          (uint8_t *)&wake_up_dur, 1);
  ret += mis2du12_read_reg(ctx, MIS2DU12_FREE_FALL, (uint8_t *)&free_fall, 1);
  ...
  ret += mis2du12_write_reg(ctx, MIS2DU12_WAKE_UP_DUR,
                            (uint8_t *)&wake_up_dur, 1);
  ret += mis2du12_write_reg(ctx, MIS2DU12_FREE_FALL, (uint8_t *)&free_fall, 1);
...
/**
  ...
  *
  */
int32_t mis2du12_free_fall_mode_get(const stmdev_ctx_t *ctx, mis2du12_ff_md_t *val)
{
  mis2du12_wake_up_dur_t wake_up_dur;
  mis2du12_free_fall_t free_fall;
  int32_t ret;
  ...
  {
    case 0x00:
      val->threshold = MIS2DU12_156mg;
      break;
    case 0x01:
      val->threshold = MIS2DU12_219mg;
      break;
    case 0x02:
      val->threshold = MIS2DU12_250mg;
      break;
    case 0x03:
      val->threshold = MIS2DU12_312mg;
      break;
    case 0x04:
      val->threshold = MIS2DU12_344mg;
      break;
    case 0x05:
      val->threshold = MIS2DU12_406mg;
      break;
    case 0x06:
      val->threshold = MIS2DU12_469mg;
      break;
    case 0x07:
      val->threshold = MIS2DU12_500mg;
      break;
    default:
      val->threshold = MIS2DU12_156mg;
      break;
...
/**
  ...
  *
  */
int32_t mis2du12_orientation_mode_set(const stmdev_ctx_t *ctx,
                                      mis2du12_orient_md_t *val)
{
  mis2du12_tap_ths_x_t tap_ths_x;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t mis2du12_orientation_mode_get(const stmdev_ctx_t *ctx,
                                      mis2du12_orient_md_t *val)
{
  mis2du12_tap_ths_x_t tap_ths_x;
  int32_t ret;
  ...
  {
    case 0x00:
      val->threshold = MIS2DU12_DEG_80;
      break;
    case 0x01:
      val->threshold = MIS2DU12_DEG_70;
      break;
    case 0x02:
      val->threshold = MIS2DU12_DEG_60;
      break;
    case 0x03:
      val->threshold = MIS2DU12_DEG_50;
      break;
    default:
      val->threshold = MIS2DU12_DEG_80;
      break;
  ...
  {
    case 0x00:
      val->deg_of_freedom = MIS2DU12_SIX;
      break;
    case 0x01:
      val->deg_of_freedom = MIS2DU12_FOUR;
      break;
    default:
      val->deg_of_freedom = MIS2DU12_SIX;
      break;
