...
int32_t lsm6dsv16b_reset_set(const stmdev_ctx_t *ctx, lsm6dsv16b_reset_t val)
{
  ...
  ctrl3.boot = (val == LSM6DSV16B_RESTORE_CAL_PARAM) ? 1 : 0;
  ctrl3.sw_reset = (val == LSM6DSV16B_RESTORE_CTRL_REGS) ? 1 : 0;
  func_cfg_access.sw_por = (val == LSM6DSV16B_GLOBAL_RST) ? 1 : 0;
                                    ...
                                    lsm6dsv16b_xl_self_test_t *val)
{
  ...
  switch (ctrl10.st_xl)
  {
    ...
    case 0x01:
      *val = ctrl10.xl_st_offset == 0 ? LSM6DSV16B_XL_ST_POSITIVE : LSM6DSV16B_XL_ST_OFFSET_POS;
      break;

    case 0x02:
      *val = ctrl10.xl_st_offset == 0 ? LSM6DSV16B_XL_ST_NEGATIVE : LSM6DSV16B_XL_ST_OFFSET_NEG;
      break;
