...
int32_t lsm6dsrx_read_reg(const stmdev_ctx_t *ctx, uint8_t reg,
                          uint8_t *data,
                          uint16_t len);
int32_t lsm6dsrx_write_reg(const stmdev_ctx_t *ctx, uint8_t reg,
                           uint8_t *data,
                           uint16_t len);
...
typedef enum
{
  ...
  LSM6DSRX_XL_ODR_416Hz  = 6,
  LSM6DSRX_XL_ODR_833Hz  = 7,
  LSM6DSRX_XL_ODR_1666Hz = 8,
  LSM6DSRX_XL_ODR_3332Hz = 9,
  LSM6DSRX_XL_ODR_6667Hz = 10,
  LSM6DSRX_XL_ODR_1Hz6   = 11, /* (low power only) */
} lsm6dsrx_odr_xl_t;
...
typedef enum
{
  ...
  LSM6DSRX_GY_ODR_416Hz  = 6,
  LSM6DSRX_GY_ODR_833Hz  = 7,
  LSM6DSRX_GY_ODR_1666Hz = 8,
  LSM6DSRX_GY_ODR_3332Hz = 9,
...
typedef enum
{
  LSM6DSRX_AUX_PULL_UP_DISC       = 1,
  LSM6DSRX_AUX_PULL_UP_CONNECT    = 0,
...
typedef enum
{
  ...
  LSM6DSRX_GY_BATCHED_AT_6Hz5     = 11,
} lsm6dsrx_bdr_gy_t;
...
typedef enum
{
  ...
  LSM6DSRX_STAMP_IN_XL_DATA     = 2,
  LSM6DSRX_STAMP_IN_GY_XL_DATA  = 1,
} lsm6dsrx_den_xl_g_t;
