...
/**
  * @brief  Convert Accelerometer lsb into mg (full-scale @320g)
  *
  * @param  lsb   Accelerometer raw data when full-scale is 320g
  * @retval       Accelerometer value in mg unit
  *
  */
...
/**
  ...
  *
  * @param  ctx      read / write interface definitions
  * @param  val      lsm6dsv320x_fifo_status_t struct
  * @retval          interface status (MANDATORY: return 0 -> no Error)
  *
  */
...
typedef enum
{
  ...
  LSM6DSV320X_XL_FILT_HP,
  LSM6DSV320X_XL_FILT_HP_SLOPE
} lsm6dsv320x_xl_filter;

/**
  * @brief Setup xl filter pipeline from lpf1 filter to UI.
  *
  * @param  ctx      read / write interface definitions
  * @param  filter   LSM6DSV320X_XL_FILT_LP_LPF2, LSM6DSV320X_XL_FILT_LP_LPF1,
  *                  LSM6DSV320X_XL_FILT_HP, LSM6DSV320X_XL_FILT_HP_SLOPE.
  * @param  bw       LSM6DSV320X_GY_ULTRA_LIGHT, LSM6DSV320X_GY_VERY_LIGHT,
  *                  LSM6DSV320X_GY_LIGHT, LSM6DSV320X_GY_MEDIUM, LSM6DSV320X_GY_STRONG,
  *                  LSM6DSV320X_GY_VERY_STRONG, LSM6DSV320X_GY_AGGRESSIVE, LSM6DSV320X_GY_XTREME
  * @param  ref_mode Enables reference mode (Availabe only in LSM6DSV320X_XL_FILT_HP mode)
  * @retval          interface status (MANDATORY: return 0 -> no Error)
  *
  */
...
typedef enum
{
  LSM6DSV320X_HP_MD_NORMAL_SLOPE_ON     = 0x2,
  LSM6DSV320X_HP_MD_NORMAL_SLOPE_OFF    = 0x0,
  LSM6DSV320X_HP_MD_REFERENCE           = 0x3,
...
typedef enum
{
  ...
  LSM6DSV320X_WK_FEED_LP_WITH_OFFSET = 0x3,
...
typedef enum
{
  LSM6DSV320X_PAD_LOW_STRENGTH     = 0x0,
  LSM6DSV320X_PAD_MIDDLE_STRENGTH  = 0x1,
  LSM6DSV320X_PAD_HIGH_STRENGTH    = 0x3,
