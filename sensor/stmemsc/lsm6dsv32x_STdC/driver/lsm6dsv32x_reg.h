...
typedef enum
{
  LSM6DSV32X_READY             = 0x0, /* No active reset in progress */
  LSM6DSV32X_GLOBAL_RST        = 0x1, /* Complete reset: boot, software reset,
                                    embedded functions, and internal filters */
  LSM6DSV32X_RESTORE_CAL_PARAM = 0x2, /* Reload trimming parameters */
  LSM6DSV32X_RESTORE_CTRL_REGS = 0x4, /* Reset control registers to default values */
} lsm6dsv32x_reset_t;
