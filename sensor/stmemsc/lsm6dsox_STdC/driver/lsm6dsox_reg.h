...
int32_t lsm6dsox_block_data_update_set(const stmdev_ctx_t *ctx,
                                       uint8_t val);
...
int32_t lsm6dsox_xl_usr_offset_x_set(const stmdev_ctx_t *ctx,
                                     uint8_t *buff);
int32_t lsm6dsox_xl_usr_offset_x_get(const stmdev_ctx_t *ctx,
                                     uint8_t *buff);

int32_t lsm6dsox_xl_usr_offset_y_set(const stmdev_ctx_t *ctx,
                                     uint8_t *buff);
int32_t lsm6dsox_xl_usr_offset_y_get(const stmdev_ctx_t *ctx,
                                     uint8_t *buff);

int32_t lsm6dsox_xl_usr_offset_z_set(const stmdev_ctx_t *ctx,
                                     uint8_t *buff);
int32_t lsm6dsox_xl_usr_offset_z_get(const stmdev_ctx_t *ctx,
                                     uint8_t *buff);
...
int32_t lsm6dsox_number_of_steps_get(const stmdev_ctx_t *ctx,
                                     uint16_t *val);
...
int32_t lsm6dsox_xl_fast_settling_get(const stmdev_ctx_t *ctx,
                                      uint8_t *val);
...
int32_t lsm6dsox_aux_drdy_on_int2_get(const stmdev_ctx_t *ctx,
                                      uint8_t *val);
...
int32_t lsm6dsox_pin_mode_set(const stmdev_ctx_t *ctx,
...
int32_t lsm6dsox_fifo_stop_on_wtm_get(const stmdev_ctx_t *ctx,
                                      uint8_t *val);
...
int32_t lsm6dsox_rst_batch_counter_set(const stmdev_ctx_t *ctx,
                                       uint8_t val);
...
int32_t lsm6dsox_sh_batch_slave_0_get(const stmdev_ctx_t *ctx,
                                      uint8_t *val);

int32_t lsm6dsox_sh_batch_slave_1_set(const stmdev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_sh_batch_slave_1_get(const stmdev_ctx_t *ctx,
                                      uint8_t *val);

int32_t lsm6dsox_sh_batch_slave_2_set(const stmdev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_sh_batch_slave_2_get(const stmdev_ctx_t *ctx,
                                      uint8_t *val);

int32_t lsm6dsox_sh_batch_slave_3_set(const stmdev_ctx_t *ctx, uint8_t val);
int32_t lsm6dsox_sh_batch_slave_3_get(const stmdev_ctx_t *ctx,
                                      uint8_t *val);
...
int32_t lsm6dsox_pedo_step_detect_get(const stmdev_ctx_t *ctx,
                                      uint8_t *val);
...
int32_t lsm6dsox_pedo_adv_detection_set(const stmdev_ctx_t *ctx,
                                        uint8_t val);
int32_t lsm6dsox_pedo_adv_detection_get(const stmdev_ctx_t *ctx,
                                        uint8_t *val);

int32_t lsm6dsox_pedo_false_step_rejection_set(const stmdev_ctx_t *ctx,
                                               uint8_t val);
int32_t lsm6dsox_pedo_false_step_rejection_get(const stmdev_ctx_t *ctx,
                                               uint8_t *val);
...
int32_t lsm6dsox_calibration_get(const stmdev_ctx_t *ctx,
