...
/**
  ...
  *
  */
int32_t __weak asm330lhhxg1_read_reg(const stmdev_ctx_t *ctx, uint8_t reg,
                                     uint8_t *data,
                                     uint16_t len)
{
  int32_t ret;
...
/**
  ...
  *
  */
int32_t __weak asm330lhhxg1_write_reg(const stmdev_ctx_t *ctx, uint8_t reg,
                                      uint8_t *data,
                                      uint16_t len)
{
  int32_t ret;
                                       ...
                                       asm330lhhxg1_fs_xl_t val)
{
  ...
  int32_t ret;
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_CTRL1_XL,
                              (uint8_t *)&ctrl1_xl, 1);
      ...
      if (ret == 0)
      {
        switch (fsm_odr)
        {
          case ASM330LHHXG1_ODR_FSM_12Hz5:
            if (odr_xl == ASM330LHHXG1_XL_ODR_OFF)
            {
          ...
          case ASM330LHHXG1_ODR_FSM_26Hz:
            ...
            else if (odr_xl == ASM330LHHXG1_XL_ODR_12Hz5)
            {
              odr_xl = ASM330LHHXG1_XL_ODR_26Hz;
            }
          ...
          case ASM330LHHXG1_ODR_FSM_52Hz:
            ...
            else if (odr_xl == ASM330LHHXG1_XL_ODR_26Hz)
            {
              odr_xl = ASM330LHHXG1_XL_ODR_52Hz;
            }
          ...
          case ASM330LHHXG1_ODR_FSM_104Hz:
            ...
            else if (odr_xl == ASM330LHHXG1_XL_ODR_52Hz)
            {
              odr_xl = ASM330LHHXG1_XL_ODR_104Hz;
            }
                                       ...
                                       asm330lhhxg1_fs_g_t val)
{
  ...
  int32_t ret;
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_CTRL2_G,
                              (uint8_t *)&ctrl2_g, 1);

  if (ret == 0)
  {
    ctrl2_g.fs_g = (uint8_t)val;
    ret = asm330lhhxg1_write_reg(ctx, ASM330LHHXG1_CTRL2_G,
                                 (uint8_t *)&ctrl2_g, 1);
  }
  ...
  if (ret == 0)
  {
         ...
         fsm_enable.fsm_enable_b.fsm16_en) == PROPERTY_ENABLE)
    {
      ...
      if (ret == 0)
      {
        ...
        {
          case ASM330LHHXG1_ODR_FSM_12Hz5:
            if (odr_gy == ASM330LHHXG1_GY_ODR_OFF)
            {
          ...
          case ASM330LHHXG1_ODR_FSM_26Hz:
            ...
            else if (odr_gy == ASM330LHHXG1_GY_ODR_12Hz5)
            {
              odr_gy = ASM330LHHXG1_GY_ODR_26Hz;
            }
          ...
          case ASM330LHHXG1_ODR_FSM_52Hz:
            ...
            else if (odr_gy == ASM330LHHXG1_GY_ODR_26Hz)
            {
              odr_gy = ASM330LHHXG1_GY_ODR_52Hz;
            }
          ...
          case ASM330LHHXG1_ODR_FSM_104Hz:
            ...
            else if (odr_gy == ASM330LHHXG1_GY_ODR_52Hz)
            {
              odr_gy = ASM330LHHXG1_GY_ODR_104Hz;
            }
                                           ...
                                           uint8_t val)
{
  ...
  int32_t ret;
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_CTRL3_C,
                              (uint8_t *)&ctrl3_c, 1);

  if (ret == 0)
  {
    ctrl3_c.bdu = (uint8_t)val;
    ret = asm330lhhxg1_write_reg(ctx, ASM330LHHXG1_CTRL3_C,
                                 (uint8_t *)&ctrl3_c, 1);
  }
                                          ...
                                          asm330lhhxg1_usr_off_w_t val)
{
  ...
  int32_t ret;
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_CTRL6_C,
                              (uint8_t *)&ctrl6_c, 1);

  if (ret == 0)
  {
    ctrl6_c.usr_off_w = (uint8_t)val;
    ret = asm330lhhxg1_write_reg(ctx, ASM330LHHXG1_CTRL6_C,
                                 (uint8_t *)&ctrl6_c, 1);
  }
                                       ...
                                       asm330lhhxg1_g_hm_mode_t val)
{
  ...
  int32_t ret;
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_CTRL7_G,
                              (uint8_t *)&ctrl7_g, 1);

  if (ret == 0)
  {
    ctrl7_g.g_hm_mode = (uint8_t)val;
    ret = asm330lhhxg1_write_reg(ctx, ASM330LHHXG1_CTRL7_G,
                                 (uint8_t *)&ctrl7_g, 1);
  }
...
int32_t asm330lhhxg1_timestamp_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_CTRL10_C,
                              (uint8_t *)&ctrl10_c, 1);
                                       ...
                                       asm330lhhxg1_rounding_t val)
{
  ...
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_CTRL5_C,
                              (uint8_t *)&ctrl5_c, 1);

  if (ret == 0)
  {
    ctrl5_c.rounding = (uint8_t)val;
    ret = asm330lhhxg1_write_reg(ctx, ASM330LHHXG1_CTRL5_C,
                                 (uint8_t *)&ctrl5_c, 1);
  }
...
/**
  ...
  *
  */
int32_t asm330lhhxg1_temperature_raw_get(const stmdev_ctx_t *ctx,
                                         int16_t *val)
{
  uint8_t buff[2];
  int32_t ret;
...
/**
  ...
  *
  */
int32_t asm330lhhxg1_angular_rate_raw_get(const stmdev_ctx_t *ctx,
                                          int16_t *val)
{
  uint8_t buff[6];
  int32_t ret;
...
/**
  ...
  *
  */
int32_t asm330lhhxg1_acceleration_raw_get(const stmdev_ctx_t *ctx,
                                          int16_t *val)
{
  uint8_t buff[6];
  int32_t ret;
...
/**
  ...
  *
  */
int32_t asm330lhhxg1_fifo_out_raw_get(const stmdev_ctx_t *ctx, uint8_t *buff)
{
  int32_t ret;

  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_FIFO_DATA_OUT_X_L, buff, 6);
                                 ...
                                 uint8_t *buf, uint8_t len)
{
  ...
  /* set page write */
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_PAGE_RW,
                              (uint8_t *)&page_rw, 1);
  if (ret != 0)
  {
    goto exit;
  ...
  ret = asm330lhhxg1_write_reg(ctx, ASM330LHHXG1_PAGE_RW,
                               (uint8_t *)&page_rw, 1);
                                     ...
                                     uint8_t *val)
{
  ...
  /* read value */
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_PAGE_VALUE, val, 1);
  if (ret != 0)
  {
    goto exit;
  }
...
int32_t asm330lhhxg1_gy_filter_lp1_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_CTRL4_C,
                              (uint8_t *)&ctrl4_c, 1);

  if (ret == 0)
  {
    ctrl4_c.lpf1_sel_g = (uint8_t)val;
    ret = asm330lhhxg1_write_reg(ctx, ASM330LHHXG1_CTRL4_C,
                                 (uint8_t *)&ctrl4_c, 1);
  }
...
int32_t asm330lhhxg1_xl_lp2_on_6d_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_CTRL8_XL,
                              (uint8_t *)&ctrl8_xl, 1);
...
{
  asm330lhhxg1_ctrl1_xl_t ctrl1_xl = {0};
  asm330lhhxg1_ctrl8_xl_t ctrl8_xl;
  int32_t ret;
                                           ...
                                           asm330lhhxg1_hp_slope_xl_en_t *val)
{
  ...
  else
  {
    ...
    {
      case 0x00:
        *val = is_low_pass ? ASM330LHHXG1_LP_ODR_DIV_4 : ASM330LHHXG1_SLOPE_ODR_DIV_4;
        break;

      case 0x01:
        *val = is_low_pass ? ASM330LHHXG1_LP_ODR_DIV_10 : ASM330LHHXG1_HP_ODR_DIV_10;
        break;

      case 0x02:
        *val = is_low_pass ? ASM330LHHXG1_LP_ODR_DIV_20 : ASM330LHHXG1_HP_ODR_DIV_20;
        break;

      case 0x03:
        *val = is_low_pass ? ASM330LHHXG1_LP_ODR_DIV_45 : ASM330LHHXG1_HP_ODR_DIV_45;
        break;

      case 0x04:
        *val = is_low_pass ? ASM330LHHXG1_LP_ODR_DIV_100 : ASM330LHHXG1_HP_ODR_DIV_100;
        break;

      case 0x05:
        *val = is_low_pass ? ASM330LHHXG1_LP_ODR_DIV_200 : ASM330LHHXG1_HP_ODR_DIV_200;
        break;

      case 0x06:
        *val = is_low_pass ? ASM330LHHXG1_LP_ODR_DIV_400 : ASM330LHHXG1_HP_ODR_DIV_400;
        break;
...
/**
  ...
  *
  */
int32_t asm330lhhxg1_xl_fast_settling_set(const stmdev_ctx_t *ctx,
                                          uint8_t val)
{
  asm330lhhxg1_ctrl8_xl_t ctrl8_xl;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t asm330lhhxg1_xl_fast_settling_get(const stmdev_ctx_t *ctx,
                                          uint8_t *val)
{
  asm330lhhxg1_ctrl8_xl_t ctrl8_xl;
  int32_t ret;
...
/**
  * @defgroup   ASM330LHHXG1_ main_serial_interface
                                      ...
                                      asm330lhhxg1_sdo_pu_en_t val)
{
  ...
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_PIN_CTRL,
                              (uint8_t *)&pin_ctrl, 1);

  if (ret == 0)
  {
    pin_ctrl.sdo_pu_en = (uint8_t)val;
    ret = asm330lhhxg1_write_reg(ctx, ASM330LHHXG1_PIN_CTRL,
                                 (uint8_t *)&pin_ctrl, 1);
  }
...
int32_t asm330lhhxg1_fifo_watermark_set(const stmdev_ctx_t *ctx, uint16_t val)
{
  ...
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_FIFO_CTRL1, (uint8_t *)&fifo_ctrl1, 1);
  ret += asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_FIFO_CTRL2, (uint8_t *)&fifo_ctrl2, 1);
  ...
  if (ret == 0)
  {
    ...
    ret = asm330lhhxg1_write_reg(ctx, ASM330LHHXG1_FIFO_CTRL1, (uint8_t *)&fifo_ctrl1, 1);
    ret += asm330lhhxg1_write_reg(ctx, ASM330LHHXG1_FIFO_CTRL2, (uint8_t *)&fifo_ctrl2, 1);
  }
...
{
  uint8_t reg[2];
  const asm330lhhxg1_fifo_status1_t *fifo_status1 = (asm330lhhxg1_fifo_status1_t *)&reg[0];
  const asm330lhhxg1_fifo_status2_t *fifo_status2 = (asm330lhhxg1_fifo_status2_t *)&reg[1];
  int32_t ret;

  /* read both FIFO_STATUS1 + FIFO_STATUS2 regs */
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_FIFO_STATUS1, (uint8_t *)reg, 2);
  if (ret == 0)
  {
...
{
  uint8_t reg[2];
  asm330lhhxg1_fifo_status2_t *fifo_status2 = (asm330lhhxg1_fifo_status2_t *)&reg[1];
  int32_t ret;
                                      ...
                                      asm330lhhxg1_den_lh_t val)
{
  ...
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_CTRL9_XL,
                              (uint8_t *)&ctrl9_xl, 1);
                                         ...
                                         uint16_t val)
{
  ...
  ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_MAG_SENSITIVITY_L,
                                      &buff[0]);

  if (ret == 0)
  {
    ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_MAG_SENSITIVITY_H,
                                        &buff[1]);
  }
                                         ...
                                         uint16_t *val)
{
  ...
  ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_MAG_SENSITIVITY_L,
                                     &buff[0]);

  ret += asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_MAG_SENSITIVITY_H,
                                      &buff[1]);
  if (ret != 0)
  {
    return ret;
...
/**
  ...
  *
  */
int32_t asm330lhhxg1_mag_soft_iron_set(const stmdev_ctx_t *ctx, const uint16_t *val)
{
  uint8_t buff[12];
  int32_t ret;
  uint8_t i;
  ...
  i = 0x00U;
  ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_MAG_SI_XX_L,
                                      &buff[i]);

  if (ret == 0)
  {
    i++;
    ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_MAG_SI_XX_H,
                                        &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_MAG_SI_XY_L,
                                        &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_MAG_SI_XY_H,
                                        &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_MAG_SI_XZ_L,
                                        &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_MAG_SI_XZ_H,
                                        &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_MAG_SI_YY_L,
                                        &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_MAG_SI_YY_H,
                                        &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_MAG_SI_YZ_L,
                                        &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_MAG_SI_YZ_H,
                                        &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_MAG_SI_ZZ_L,
                                        &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_MAG_SI_ZZ_H,
                                        &buff[i]);
  }
...
int32_t asm330lhhxg1_mag_soft_iron_get(const stmdev_ctx_t *ctx, uint16_t *val)
{
  ...
  i = 0x00U;
  ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_MAG_SI_XX_L,
                                     &buff[i]);

  if (ret == 0)
  {
    i++;
    ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_MAG_SI_XX_H,
                                       &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_MAG_SI_XY_L,
                                       &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_MAG_SI_XY_H,
                                       &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_MAG_SI_XZ_L,
                                       &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_MAG_SI_XZ_H,
                                       &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_MAG_SI_YY_L,
                                       &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_MAG_SI_YY_H,
                                       &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_MAG_SI_YZ_L,
                                       &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_MAG_SI_YZ_H,
                                       &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_MAG_SI_ZZ_L,
                                       &buff[i]);
  }
  ...
  {
    i++;
    ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_MAG_SI_ZZ_H,
                                       &buff[i]);
  }
...
int32_t asm330lhhxg1_long_cnt_set(const stmdev_ctx_t *ctx, uint16_t val)
{
  ...
  if (ret == 0)
  {
    ret = asm330lhhxg1_write_reg(ctx, ASM330LHHXG1_FSM_LONG_COUNTER_L, buff,
                                 2);
  }
...
int32_t asm330lhhxg1_long_cnt_get(const stmdev_ctx_t *ctx, uint16_t *val)
{
  ...
  if (ret == 0)
  {
    ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_FSM_LONG_COUNTER_L, buff,
                                2);
    if (ret == 0)
    {
      *val = buff[1];
                                            ...
                                            uint16_t val)
{
  ...
  buff[1] = (uint8_t)(val / 256U);
  buff[0] = (uint8_t)(val - (buff[1] * 256U));
  ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_FSM_LC_TIMEOUT_L,
                                      &buff[0]);
                                            ...
                                            uint16_t *val)
{
  ...
  ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_FSM_LC_TIMEOUT_L,
                                     &buff[0]);
                                           ...
                                           uint16_t val)
{
  ...
  buff[1] = (uint8_t)(val / 256U);
  buff[0] = (uint8_t)(val - (buff[1] * 256U));
  ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_FSM_START_ADD_L,
                                      &buff[0]);

  if (ret == 0)
  {
    ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_FSM_START_ADD_H,
                                        &buff[1]);
  }
                                           ...
                                           uint16_t *val)
{
  ...
  ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_FSM_START_ADD_L,
                                     &buff[0]);

  if (ret == 0)
  {
    ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_FSM_START_ADD_H,
                                       &buff[1]);
    if (ret == 0)
    {
      *val = buff[1];
...
/**
  ...
  *
  */
int32_t asm330lhhxg1_mlc_mag_sensitivity_set(const stmdev_ctx_t *ctx,
                                             uint16_t val)
{
  uint8_t buff[2];
  int32_t ret;
...
/**
  ...
  *
  */
int32_t asm330lhhxg1_mlc_mag_sensitivity_get(const stmdev_ctx_t *ctx,
                                             uint16_t *val)
{
  uint8_t buff[2];
  int32_t ret;
                                          ...
                                          uint8_t len)
{
  ...
  if (ret == 0)
  {
    ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_SENSOR_HUB_1, val, len);
  }
...
int32_t asm330lhhxg1_sh_write_mode_get(const stmdev_ctx_t *ctx,
                                       asm330lhhxg1_write_once_t *val)
{
  asm330lhhxg1_master_config_t master_config = {0};
  int32_t ret;
                                      ...
                                      asm330lhhxg1_sh_cfg_read_t *val)
{
  ...
  if (ret == 0)
  {
    ...
    slv1_add.r_1 = 1;
    ret = asm330lhhxg1_write_reg(ctx, ASM330LHHXG1_SLV1_ADD,
                                 (uint8_t *)&slv1_add, 1);
  }
                                   ...
                                   asm330lhhxg1_status_master_t *val)
{
  ...
  if (ret == 0)
  {
    ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_STATUS_MASTER,
                                (uint8_t *)val, 1);
  }
