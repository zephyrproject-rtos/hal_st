...
/**
  ...
  *            ism330bx enhanced inertial module.
  * @{
  *
  */
...
/**
  ...
  *
  */
int32_t __weak ism330bx_read_reg(const stmdev_ctx_t *ctx, uint8_t reg,
                                 uint8_t *data,
                                 uint16_t len)
{
  int32_t ret;
...
/**
  ...
  *
  */
int32_t __weak ism330bx_write_reg(const stmdev_ctx_t *ctx, uint8_t reg,
                                  uint8_t *data,
                                  uint16_t len)
{
  int32_t ret;
...
int32_t ism330bx_reset_set(const stmdev_ctx_t *ctx, ism330bx_reset_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_CTRL3, (uint8_t *)&ctrl3, 1);
  ret += ism330bx_read_reg(ctx, ISM330BX_FUNC_CFG_ACCESS, (uint8_t *)&func_cfg_access, 1);
  ...
  ctrl3.boot = (val == ISM330BX_RESTORE_CAL_PARAM) ? 1 : 0;
  ctrl3.sw_reset = (val == ISM330BX_RESTORE_CTRL_REGS) ? 1 : 0;
  func_cfg_access.sw_por = (val == ISM330BX_GLOBAL_RST) ? 1 : 0;

  ret = ism330bx_write_reg(ctx, ISM330BX_CTRL3, (uint8_t *)&ctrl3, 1);
  ret += ism330bx_write_reg(ctx, ISM330BX_FUNC_CFG_ACCESS, (uint8_t *)&func_cfg_access, 1);
...
/**
  ...
  *
  */
int32_t ism330bx_mem_bank_get(const stmdev_ctx_t *ctx, ism330bx_mem_bank_t *val)
{
  ism330bx_func_cfg_access_t func_cfg_access;
  int32_t ret;
...
int32_t ism330bx_device_id_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_WHO_AM_I, (uint8_t *)&who_am_i, 1);
  if (ret != 0)
  {
    return ret;
  }
...
/**
  ...
  *
  * @param  ctx      read / write interface definitions
  * @param  val      ism330bx_xl_data_rate_t enum
  * @retval          interface status (MANDATORY: return 0 -> no Error)
  *
  */
                                  ...
                                  ism330bx_xl_data_rate_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_CTRL1, (uint8_t *)&ctrl1, 1);
  if (ret == 0)
  {
    ctrl1.odr_xl = (uint8_t)val & 0xFU;
    ret = ism330bx_write_reg(ctx, ISM330BX_CTRL1, (uint8_t *)&ctrl1, 1);
  }
...
/**
  ...
  *
  * @param  ctx      read / write interface definitions
  * @param  val      ism330bx_gy_data_rate_t enum
  * @retval          interface status (MANDATORY: return 0 -> no Error)
  *
  */
                                  ...
                                  ism330bx_gy_data_rate_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_CTRL2, (uint8_t *)&ctrl2, 1);

  if (ret == 0)
  {
    ctrl2.odr_g = (uint8_t)val & 0xFU;
    ret = ism330bx_write_reg(ctx, ISM330BX_CTRL2, (uint8_t *)&ctrl2, 1);
  }
                                     ...
                                     ism330bx_data_ready_mode_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_CTRL4, (uint8_t *)&ctrl4, 1);

  if (ret == 0)
  {
    ctrl4.drdy_pulsed = (uint8_t)val & 0x1U;
    ret = ism330bx_write_reg(ctx, ISM330BX_CTRL4, (uint8_t *)&ctrl4, 1);
  }
                                   ...
                                   ism330bx_gy_full_scale_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_CTRL6, (uint8_t *)&ctrl6, 1);

  if (ret == 0)
  {
    ctrl6.fs_g = (uint8_t)val & 0xFU;
    ret = ism330bx_write_reg(ctx, ISM330BX_CTRL6, (uint8_t *)&ctrl6, 1);
  }
                                   ...
                                   ism330bx_xl_full_scale_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_CTRL8, (uint8_t *)&ctrl8, 1);

  if (ret == 0)
  {
    ctrl8.fs_xl = (uint8_t)val & 0x3U;
    ret = ism330bx_write_reg(ctx, ISM330BX_CTRL8, (uint8_t *)&ctrl8, 1);
  }
                                  ...
                                  ism330bx_xl_self_test_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_CTRL10, (uint8_t *)&ctrl10, 1);

  if (ret == 0)
  {
    ctrl10.st_xl = (uint8_t)val & 0x3U;
    ctrl10.xl_st_offset = ((uint8_t)val & 0x04U) >> 2;
    ret = ism330bx_write_reg(ctx, ISM330BX_CTRL10, (uint8_t *)&ctrl10, 1);
  }
                                 ...
                                 ism330bx_all_sources_t *val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_FUNCTIONS_ENABLE, (uint8_t *)&functions_enable, 1);
  if (ret == 0)
  {
    functions_enable.dis_rst_lir_all_int = PROPERTY_ENABLE;
    ret = ism330bx_write_reg(ctx, ISM330BX_FUNCTIONS_ENABLE, (uint8_t *)&functions_enable, 1);
  }

  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_FIFO_STATUS1, (uint8_t *)&buff, 4);
  }
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_WAKE_UP_SRC, (uint8_t *)&buff, 7);
  }
  ...
  if (ret == 0)
  {
    ...
    if (ret == 0)
    {
      ret = ism330bx_read_reg(ctx, ISM330BX_EMB_FUNC_EXEC_STATUS, (uint8_t *)&emb_func_exec_status,
                              1);
    }
    if (ret == 0)
    {
      ret = ism330bx_read_reg(ctx, ISM330BX_EMB_FUNC_SRC, (uint8_t *)&emb_func_src, 1);
    }
                                     ...
                                     ism330bx_data_ready_t *val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_STATUS_REG, (uint8_t *)&status, 1);
  if (ret != 0)
  {
    return ret;
  }
...
int32_t ism330bx_temperature_raw_get(const stmdev_ctx_t *ctx, int16_t *val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_OUT_TEMP_L, &buff[0], 2);
  if (ret != 0)
  {
    return ret;
  }
...
int32_t ism330bx_angular_rate_raw_get(const stmdev_ctx_t *ctx, int16_t *val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_OUTX_L_G, &buff[0], 6);
  if (ret != 0)
  {
    return ret;
  }
...
int32_t ism330bx_acceleration_raw_get(const stmdev_ctx_t *ctx, int16_t *val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_OUTZ_L_A, &buff[0], 6);
  if (ret != 0)
  {
    return ret;
  }
...
int32_t ism330bx_dual_acceleration_raw_get(const stmdev_ctx_t *ctx, int16_t *val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_UI_OUTZ_L_A_DUALC, &buff[0], 6);
  if (ret != 0)
  {
    return ret;
  }
...
int32_t ism330bx_ah_qvar_raw_get(const stmdev_ctx_t *ctx, int16_t *val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_AH_QVAR_OUT_L, &buff[0], 2);
  if (ret != 0)
  {
    return ret;
  }
...
int32_t ism330bx_odr_cal_reg_get(const stmdev_ctx_t *ctx, int8_t *val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_INTERNAL_FREQ, (uint8_t *)&internal_freq, 1);
  if (ret != 0)
  {
    return ret;
  }
...
int32_t ism330bx_tdm_xl_axis_set(const stmdev_ctx_t *ctx, ism330bx_tdm_xl_axis_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_TDM_CFG1, (uint8_t *)&tdm_cfg1, 1);
  if (ret == 0)
  {
    tdm_cfg1.tdm_xl_z_en = val.z;
    tdm_cfg1.tdm_xl_y_en = val.y;
    tdm_cfg1.tdm_xl_x_en = val.x;
    ret = ism330bx_write_reg(ctx, ISM330BX_TDM_CFG1, (uint8_t *)&tdm_cfg1, 1);
  }
                             ...
                             uint8_t *buf, uint8_t len)
{
  ...
  /* set page write */
  ret = ism330bx_read_reg(ctx, ISM330BX_PAGE_RW, (uint8_t *)&page_rw, 1);
  if (ret != 0)
  {
    goto exit;
  }
  ...
  ret = ism330bx_write_reg(ctx, ISM330BX_PAGE_RW, (uint8_t *)&page_rw, 1);

  /* select page */
  ret += ism330bx_read_reg(ctx, ISM330BX_PAGE_SEL, (uint8_t *)&page_sel, 1);
  if (ret != 0)
  {
    goto exit;
  }
  ...
  ret += ism330bx_write_reg(ctx, ISM330BX_PAGE_SEL, (uint8_t *)&page_sel,
                            1);
  if (ret != 0)
  {
    goto exit;
  ...
  ret += ism330bx_write_reg(ctx, ISM330BX_PAGE_ADDRESS,
  ...
  {
    ret = ism330bx_write_reg(ctx, ISM330BX_PAGE_VALUE, &buf[i], 1);
    if (ret != 0)
    {
      goto exit;
    }
                            ...
                            uint8_t *buf, uint8_t len)
{
  ...
  for (i = 0; ((i < len) && (ret == 0)); i++)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_PAGE_VALUE, &buf[i], 1);
    if (ret != 0)
    {
      goto exit;
    }
...
int32_t ism330bx_timestamp_raw_get(const stmdev_ctx_t *ctx, uint32_t *val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_TIMESTAMP0, &buff[0], 4);
  if (ret != 0)
  {
    return ret;
  }
                                     ...
                                     ism330bx_filt_anti_spike_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_IF_CFG, (uint8_t *)&if_cfg, 1);

  if (ret == 0)
  {
    if_cfg.asf_ctrl = (uint8_t)val & 0x01U;
    ret = ism330bx_write_reg(ctx, ISM330BX_IF_CFG, (uint8_t *)&if_cfg, 1);
  }
                                        ...
                                        ism330bx_filt_settling_mask_t val)
{
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_EMB_FUNC_CFG, (uint8_t *)&emb_func_cfg, 1);
  }
  ...
  if (ret == 0)
  {
    ...
    ret = ism330bx_write_reg(ctx, ISM330BX_EMB_FUNC_CFG, (uint8_t *)&emb_func_cfg, 1);
  }

  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_TDM_CFG2, (uint8_t *)&tdm_cfg2, 1);
  }

  if (ret == 0)
  {
    tdm_cfg2.tdm_data_mask = val.tdm_excep_code;
    ret = ism330bx_write_reg(ctx, ISM330BX_TDM_CFG2, (uint8_t *)&tdm_cfg2, 1);
  }
                                       ...
                                       ism330bx_filt_ah_qvar_conf_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_CTRL8, (uint8_t *)&ctrl8, 1);
  ret += ism330bx_read_reg(ctx, ISM330BX_CTRL9, (uint8_t *)&ctrl9, 1);
  ...
  if (ret == 0)
  {
    ret = ism330bx_write_reg(ctx, ISM330BX_CTRL9, (uint8_t *)&ctrl9, 1);
  }
                                        ...
                                        ism330bx_filt_wkup_act_feed_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_TAP_CFG0, (uint8_t *)&tap_cfg0, 1);
  ret += ism330bx_read_reg(ctx, ISM330BX_WAKE_UP_THS, (uint8_t *)&wake_up_ths, 1);
  ...
  if (ret == 0)
  {
    ...
    ret = ism330bx_write_reg(ctx, ISM330BX_TAP_CFG0, (uint8_t *)&tap_cfg0, 1);
  }
  if (ret == 0)
  {

    ret = ism330bx_write_reg(ctx, ISM330BX_WAKE_UP_THS, (uint8_t *)&wake_up_ths, 1);
  }
...
int32_t ism330bx_ui_sdo_pull_up_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_PIN_CTRL, (uint8_t *)&pin_ctrl, 1);
  if (ret == 0)
  {
    pin_ctrl.sdo_pu_en = val;
    ret = ism330bx_write_reg(ctx, ISM330BX_PIN_CTRL, (uint8_t *)&pin_ctrl, 1);
  }
...
/**
  ...
  *
  */
int32_t ism330bx_spi_mode_get(const stmdev_ctx_t *ctx, ism330bx_spi_mode_t *val)
{
  ism330bx_if_cfg_t if_cfg;
  int32_t ret;
                                  ...
                                  ism330bx_i3c_ibi_time_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_CTRL5, (uint8_t *)&ctrl5, 1);
  if (ret == 0)
  {
    ctrl5.bus_act_sel = (uint8_t)val & 0x03U;
    ret = ism330bx_write_reg(ctx, ISM330BX_CTRL5, (uint8_t *)&ctrl5, 1);
  }
                                    ...
                                    ism330bx_pin_int_route_t val)
{
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_EMB_FUNC_INT1, (uint8_t *)&emb_func_int1, 1);
  }
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_FSM_INT1, (uint8_t *)&fsm_int1, 1);
  }
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_MLC_INT1, (uint8_t *)&mlc_int1, 1);
  }
  ...
  if (ret == 0)
  {
    ...
    ret = ism330bx_write_reg(ctx, ISM330BX_EMB_FUNC_INT1, (uint8_t *)&emb_func_int1, 1);
  }
  if (ret == 0)
  {
    ...
    ret = ism330bx_write_reg(ctx, ISM330BX_FSM_INT1, (uint8_t *)&fsm_int1, 1);
  }
  if (ret == 0)
  {
    ...
    ret = ism330bx_write_reg(ctx, ISM330BX_MLC_INT1, (uint8_t *)&mlc_int1, 1);
  }
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_INT2_CTRL, (uint8_t *)&int2_ctrl, 1);
  }
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_MD2_CFG, (uint8_t *)&md2_cfg, 1);
  }

  if (ret == 0)
  {
    md2_cfg.int2_timestamp = val.timestamp;
    ret = ism330bx_write_reg(ctx, ISM330BX_MD2_CFG, (uint8_t *)&md2_cfg, 1);
  }

  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_INACTIVITY_DUR, (uint8_t *)&inactivity_dur, 1);
  }

  if (ret == 0)
  {
    inactivity_dur.sleep_status_on_int = val.sleep_status;
    ret = ism330bx_write_reg(ctx, ISM330BX_INACTIVITY_DUR, (uint8_t *)&inactivity_dur, 1);
  }


  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_INT1_CTRL, (uint8_t *)&int1_ctrl, 1);
  }
  ...
  if (ret == 0)
  {
    ...
    ret = ism330bx_write_reg(ctx, ISM330BX_INT1_CTRL, (uint8_t *)&int1_ctrl, 1);
  }

  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_MD1_CFG, (uint8_t *)&md1_cfg, 1);
  }
  ...
  if (ret == 0)
  {
    ...
    ret = ism330bx_write_reg(ctx, ISM330BX_MD1_CFG, (uint8_t *)&md1_cfg, 1);
  }

  if (ret == 0)
  {
    ret = ism330bx_ln_pg_read(ctx, ISM330BX_PEDO_CMD_REG, (uint8_t *)&pedo_cmd_reg, 1);
  }

  if (ret == 0)
  {
    pedo_cmd_reg.carry_count_en = val.step_count_overflow;
    ret = ism330bx_ln_pg_write(ctx, ISM330BX_PEDO_CMD_REG, (uint8_t *)&pedo_cmd_reg, 1);
  }


  if (ret == 0)
  {
    ret = ism330bx_pin_int2_route_get(ctx, &pin_int2_route);
  }
                                    ...
                                    ism330bx_pin_int_route_t val)
{
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_EMB_FUNC_INT2, (uint8_t *)&emb_func_int2, 1);
    ret += ism330bx_read_reg(ctx, ISM330BX_FSM_INT2, (uint8_t *)&fsm_int2, 1);
    ret += ism330bx_read_reg(ctx, ISM330BX_MLC_INT2, (uint8_t *)&mlc_int2, 1);
  }
  ...
  if (ret == 0)
  {
    ...
    ret = ism330bx_write_reg(ctx, ISM330BX_EMB_FUNC_INT2, (uint8_t *)&emb_func_int2, 1);
  }
  if (ret == 0)
  {
    ...
    ret = ism330bx_write_reg(ctx, ISM330BX_FSM_INT2, (uint8_t *)&fsm_int2, 1);
  }
  if (ret == 0)
  {
    ...
    ret = ism330bx_write_reg(ctx, ISM330BX_MLC_INT2, (uint8_t *)&mlc_int2, 1);
  }
  ...
  if (ret == 0)
  {
    ret = ism330bx_pin_int1_route_get(ctx, &pin_int1_route);
  }
...
/**
  ...
  *
  */
int32_t ism330bx_act_mode_get(const stmdev_ctx_t *ctx, ism330bx_act_mode_t *val)
{
  ism330bx_functions_enable_t functions_enable;
  int32_t ret;
                                    ...
                                    ism330bx_act_thresholds_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_INACTIVITY_DUR, (uint8_t *)&inactivity_dur, 1);
  ret += ism330bx_read_reg(ctx, ISM330BX_INACTIVITY_THS, (uint8_t *)&inactivity_ths, 1);
  ret += ism330bx_read_reg(ctx, ISM330BX_WAKE_UP_THS, (uint8_t *)&wake_up_ths, 1);
  ...
  if (ret == 0)
  {
    ...
    ret = ism330bx_write_reg(ctx, ISM330BX_INACTIVITY_THS, (uint8_t *)&inactivity_ths, 1);
  }
  if (ret == 0)
  {
                                           ...
                                           ism330bx_act_wkup_time_windows_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_WAKE_UP_DUR, (uint8_t *)&wake_up_dur, 1);
  if (ret == 0)
  {
    wake_up_dur.wake_dur = val.shock;
    wake_up_dur.sleep_dur = val.quiet;
    ret = ism330bx_write_reg(ctx, ISM330BX_WAKE_UP_DUR, (uint8_t *)&wake_up_dur, 1);
  }
                                    ...
                                    ism330bx_tap_thresholds_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_TAP_CFG1, (uint8_t *)&tap_cfg1, 1);
  ret += ism330bx_read_reg(ctx, ISM330BX_TAP_CFG2, (uint8_t *)&tap_cfg2, 1);
  ret += ism330bx_read_reg(ctx, ISM330BX_TAP_THS_6D, (uint8_t *)&tap_ths_6d, 1);
  if (ret != 0)
  {
    return ret;
  }
  ...
  if (ret == 0)
  {
    ret = ism330bx_write_reg(ctx, ISM330BX_TAP_THS_6D, (uint8_t *)&tap_ths_6d, 1);
  }
  if (ret == 0)
  {
    ret = ism330bx_write_reg(ctx, ISM330BX_TAP_CFG2, (uint8_t *)&tap_cfg2, 1);
  }
  if (ret == 0)
  {
    ret = ism330bx_write_reg(ctx, ISM330BX_TAP_CFG1, (uint8_t *)&tap_cfg1, 1);
  }
...
{
  ism330bx_tap_dur_t tap_dur;
  int32_t ret;

  ret = ism330bx_read_reg(ctx, ISM330BX_TAP_DUR, (uint8_t *)&tap_dur, 1);
  if (ret == 0)
  {
    tap_dur.shock = val.shock;
    tap_dur.quiet = val.quiet;
    tap_dur.dur = val.tap_gap;
    ret = ism330bx_write_reg(ctx, ISM330BX_TAP_DUR, (uint8_t *)&tap_dur, 1);
  }
...
/**
  ...
  *
  */
int32_t ism330bx_tap_mode_get(const stmdev_ctx_t *ctx, ism330bx_tap_mode_t *val)
{
  ism330bx_wake_up_ths_t wake_up_ths;
  int32_t ret;
...
int32_t ism330bx_ff_time_windows_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_FREE_FALL, (uint8_t *)&free_fall, 1);
  }

  if (ret == 0)
  {
    free_fall.ff_dur = (uint8_t)val & 0x1FU;
    ret = ism330bx_write_reg(ctx, ISM330BX_FREE_FALL, (uint8_t *)&free_fall, 1);
  }
...
int32_t ism330bx_fifo_watermark_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_FIFO_CTRL1, (uint8_t *)&fifo_ctrl1, 1);

  if (ret == 0)
  {
    fifo_ctrl1.wtm = val;
    ret = ism330bx_write_reg(ctx, ISM330BX_FIFO_CTRL1, (uint8_t *)&fifo_ctrl1, 1);
  }
...
int32_t ism330bx_fifo_xl_dual_fsm_batch_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_FIFO_CTRL2, (uint8_t *)&fifo_ctrl2, 1);
  if (ret == 0)
  {
    fifo_ctrl2.xl_dualc_batch_from_fsm = val;
    ret = ism330bx_write_reg(ctx, ISM330BX_FIFO_CTRL2, (uint8_t *)&fifo_ctrl2, 1);
  }
                                                  ...
                                                  uint8_t val)
{
  ...
  if (ret == 0)
  {
    ...
    if (ret == 0)
    {
      ret = ism330bx_read_reg(ctx, ISM330BX_EMB_FUNC_EN_B, (uint8_t *)&emb_func_en_b, 1);
    }
    if (ret == 0)
    {
      emb_func_en_b.fifo_compr_en = val;
      ret = ism330bx_write_reg(ctx, ISM330BX_EMB_FUNC_EN_B, (uint8_t *)&emb_func_en_b, 1);
    }
...
/**
  ...
  *
  * @param  ctx      read / write interface definitions
  * @param  val      ism330bx_fifo_xl_batch_t enum
  * @retval          interface status (MANDATORY: return 0 -> no Error)
  *
  */
                                   ...
                                   ism330bx_fifo_xl_batch_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_FIFO_CTRL3, (uint8_t *)&fifo_ctrl3, 1);
  if (ret == 0)
  {
    fifo_ctrl3.bdr_xl = (uint8_t)val & 0xFU;
    ret = ism330bx_write_reg(ctx, ISM330BX_FIFO_CTRL3, (uint8_t *)&fifo_ctrl3, 1);
  }
...
/**
  ...
  *
  * @param  ctx      read / write interface definitions
  * @param  val      ism330bx_fifo_gy_batch_t enum
  * @retval          interface status (MANDATORY: return 0 -> no Error)
  *
  */
                               ...
                               ism330bx_fifo_mode_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_FIFO_CTRL4, (uint8_t *)&fifo_ctrl4, 1);
  if (ret == 0)
  {
    fifo_ctrl4.fifo_mode = (uint8_t)val & 0x07U;
    ret = ism330bx_write_reg(ctx, ISM330BX_FIFO_CTRL4, (uint8_t *)&fifo_ctrl4, 1);
  }
                                                  ...
                                                  uint16_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_COUNTER_BDR_REG1, (uint8_t *)&counter_bdr_reg1, 1);

  if (ret == 0)
  {
    counter_bdr_reg2.cnt_bdr_th = (uint8_t)val & 0xFFU;
    counter_bdr_reg1.cnt_bdr_th = (uint8_t)(val >> 8) & 0x3U;
    ret = ism330bx_write_reg(ctx, ISM330BX_COUNTER_BDR_REG1, (uint8_t *)&counter_bdr_reg1, 1);
    ret += ism330bx_write_reg(ctx, ISM330BX_COUNTER_BDR_REG2, (uint8_t *)&counter_bdr_reg2, 1);
  }
                                                  ...
                                                  uint16_t *val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_COUNTER_BDR_REG1, &buff[0], 2);
  if (ret != 0)
  {
    return ret;
  }
                                     ...
                                     ism330bx_fifo_sflp_raw_t val)
{
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_EMB_FUNC_FIFO_EN_A, (uint8_t *)&emb_func_fifo_en_a, 1);
  }
  ...
  if (ret == 0)
  {
    ...
    ret += ism330bx_write_reg(ctx, ISM330BX_EMB_FUNC_FIFO_EN_A,
...
{
  uint8_t buff[2];
  ism330bx_fifo_status2_t status;
  int32_t ret;

  ret = ism330bx_read_reg(ctx, ISM330BX_FIFO_STATUS1, (uint8_t *)&buff[0], 2);
  if (ret != 0)
  {
    return ret;
  }
...
/**
  ...
  *
  * @param  ctx      read / write interface definitions
  * @param  val      ism330bx_fifo_out_raw_t enum
  * @retval          interface status (MANDATORY: return 0 -> no Error)
  *
  */
                                  ...
                                  ism330bx_fifo_out_raw_t *val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_FIFO_DATA_OUT_TAG, buff, 7);
  if (ret != 0)
  {
    return ret;
  }
...
int32_t ism330bx_fifo_stpcnt_batch_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    ...
    ret = ism330bx_write_reg(ctx, ISM330BX_EMB_FUNC_FIFO_EN_A, (uint8_t *)&emb_func_fifo_en_a, 1);
  }
...
int32_t ism330bx_fifo_mlc_filt_batch_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_EMB_FUNC_FIFO_EN_B, (uint8_t *)&emb_func_fifo_en_b, 1);
  }

  if (ret == 0)
  {
    emb_func_fifo_en_b.mlc_filter_feature_fifo_en = val;
    ret = ism330bx_write_reg(ctx, ISM330BX_EMB_FUNC_FIFO_EN_B, (uint8_t *)&emb_func_fifo_en_b, 1);
  }
                                 ...
                                 ism330bx_stpcnt_mode_t val)
{
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_EMB_FUNC_EN_A, (uint8_t *)&emb_func_en_a, 1);
    ret += ism330bx_read_reg(ctx, ISM330BX_EMB_FUNC_EN_B, (uint8_t *)&emb_func_en_b, 1);
  }
  ...
  if (ret == 0)
  {
    ...
    ret = ism330bx_write_reg(ctx, ISM330BX_EMB_FUNC_EN_A, (uint8_t *)&emb_func_en_a, 1);
  }
...
int32_t ism330bx_stpcnt_steps_get(const stmdev_ctx_t *ctx, uint16_t *val)
{
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_STEP_COUNTER_L, &buff[0], 2);
  }
...
int32_t ism330bx_stpcnt_rst_step_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    ...
    ret = ism330bx_write_reg(ctx, ISM330BX_EMB_FUNC_SRC, (uint8_t *)&emb_func_src, 1);
  }
...
int32_t ism330bx_stpcnt_debounce_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  ret = ism330bx_ln_pg_read(ctx, ISM330BX_PEDO_DEB_STEPS_CONF, (uint8_t *)&pedo_deb_steps_conf,
                            1);
  if (ret == 0)
  {
    pedo_deb_steps_conf.deb_step = val;
    ret = ism330bx_ln_pg_write(ctx, ISM330BX_PEDO_DEB_STEPS_CONF, (uint8_t *)&pedo_deb_steps_conf,
                               1);
  }
...
int32_t ism330bx_stpcnt_period_set(const stmdev_ctx_t *ctx, uint16_t val)
{
  ...
  ret = ism330bx_ln_pg_write(ctx, ISM330BX_PEDO_SC_DELTAT_L, (uint8_t *)&buff[0], 2);
...
int32_t ism330bx_stpcnt_period_get(const stmdev_ctx_t *ctx, uint16_t *val)
{
  ...
  ret = ism330bx_ln_pg_read(ctx, ISM330BX_PEDO_SC_DELTAT_L, &buff[0], 2);
...
int32_t ism330bx_sflp_game_rotation_set(const stmdev_ctx_t *ctx, uint16_t val)
{
  ...
  if (ret == 0)
  {
    ...
    ret += ism330bx_write_reg(ctx, ISM330BX_EMB_FUNC_EN_A,
...
{
  ism330bx_sflp_odr_t sflp_odr;
  int32_t ret;

  ret = ism330bx_mem_bank_set(ctx, ISM330BX_EMBED_FUNC_MEM_BANK);
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_SFLP_ODR, (uint8_t *)&sflp_odr, 1);
  }
  if (ret == 0)
  {
    sflp_odr.sflp_game_odr = (uint8_t)val & 0x07U;
    ret += ism330bx_write_reg(ctx, ISM330BX_SFLP_ODR, (uint8_t *)&sflp_odr,
                              1);
  }
                                     ...
                                     ism330bx_sflp_gbias_t *val)
{
  ...
  ret = ism330bx_sflp_data_rate_get(ctx, &sflp_odr);
  if (ret != 0)
  {
    return ret;
  }
  ...
  ret += ism330bx_read_reg(ctx, ISM330BX_CTRL1, conf_saved, 2);
  ret += ism330bx_xl_mode_set(ctx, ISM330BX_XL_HIGH_PERFORMANCE_MD);
  ret += ism330bx_gy_mode_set(ctx, ISM330BX_GY_HIGH_PERFORMANCE_MD);
  ...
  if ((conf_saved[0] & 0x0FU) == ISM330BX_XL_ODR_OFF)
  {
    ret += ism330bx_xl_data_rate_set(ctx, ISM330BX_XL_ODR_AT_120Hz);
  }
  ...
  if (ret == 0)
  {
    ret += ism330bx_read_reg(ctx, ISM330BX_EMB_FUNC_EN_A, emb_func_en_saved,
                             2);
  }
  if (ret == 0)
  {
    ret += ism330bx_write_reg(ctx, ISM330BX_EMB_FUNC_EN_A, reg_zero, 2);
  }
  if (ret == 0)
  {
    do
    {
      ret += ism330bx_read_reg(ctx, ISM330BX_EMB_FUNC_EXEC_STATUS,
  ...
  if (ret == 0)
  {
    ...
    ret += ism330bx_write_reg(ctx, ISM330BX_EMB_FUNC_EN_A, emb_func_en_saved,
                              2);
  }
  ret += ism330bx_mem_bank_set(ctx, ISM330BX_MAIN_MEM_BANK);

  ret += ism330bx_xl_full_scale_get(ctx, &xl_fs);
  if (ret != 0)
  {
    return ret;
  }
  ...
  do
  {
    ret += ism330bx_flag_data_ready_get(ctx, &drdy);
  } while (drdy.drdy_xl != 1);
  ret += ism330bx_acceleration_raw_get(ctx, xl_data);
  if (ret != 0)
  {
    return ret;
  }
  ...
  master_config = 0x40;
  ret += ism330bx_write_reg(ctx, ISM330BX_FUNC_CFG_ACCESS, &master_config,
                            1);
  if (ret != 0)
  {
    return ret;
  ...
  for (i = 0; i < 3; i++)
  {
    ...
    ret += ism330bx_write_reg(ctx, 0x02 + 3 * i, &data_ptr[j++], 1);
    ret += ism330bx_write_reg(ctx, 0x03 + 3 * i, &data_ptr[j++], 1);
    ret += ism330bx_write_reg(ctx, 0x04 + 3 * i, &data_ptr[j], 1);
  }
  for (i = 0; i < 3; i++)
  {
    j = 0;
    data_tmp = 0;
    ret += ism330bx_write_reg(ctx, 0x0B + 3 * i, &data_ptr[j++], 1);
    ret += ism330bx_write_reg(ctx, 0x0C + 3 * i, &data_ptr[j++], 1);
    ret += ism330bx_write_reg(ctx, 0x0D + 3 * i, &data_ptr[j], 1);
  }
  master_config = 0x00;
  ret += ism330bx_write_reg(ctx, ISM330BX_FUNC_CFG_ACCESS, &master_config,
                            1);
  ...
  ret += ism330bx_ln_pg_write(ctx, ISM330BX_SFLP_GAME_GBIASX_L,
                              (uint8_t *)gbias_hf, 6);
  if (ret != 0)
  {
    return ret;
  ...
  ret += ism330bx_write_reg(ctx, ISM330BX_CTRL1, conf_saved, 2);
  if (ret != 0)
  {
    return ret;
  }
...
int32_t ism330bx_sflp_configure(const stmdev_ctx_t *ctx)
{
  ...
  ret = ism330bx_ln_pg_write(ctx, 0xD2, &val, 1);
...
{
  ism330bx_ctrl_status_t status;
  int32_t ret;

  ret = ism330bx_read_reg(ctx, ISM330BX_CTRL_STATUS, (uint8_t *)&status, 1);
  if (ret != 0)
  {
    return ret;
  }

  *val = (status.fsm_wr_ctrl_status == 0) ? ISM330BX_STD_IF_CONTROL : ISM330BX_FSM_CONTROL;
...
int32_t ism330bx_fsm_mode_set(const stmdev_ctx_t *ctx, ism330bx_fsm_mode_t val)
{
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_FSM_ENABLE, (uint8_t *)&fsm_enable, 1);
  }
  ...
  if (ret == 0)
  {
    ...
    ret = ism330bx_write_reg(ctx, ISM330BX_FSM_ENABLE, (uint8_t *)&fsm_enable, 1);
  }
  if (ret == 0)
  {
    ret = ism330bx_write_reg(ctx, ISM330BX_EMB_FUNC_EN_B, (uint8_t *)&emb_func_en_b, 1);
...
/**
  ...
  *
  */
int32_t ism330bx_fsm_mode_get(const stmdev_ctx_t *ctx, ism330bx_fsm_mode_t *val)
{
  ism330bx_fsm_enable_t fsm_enable;
  int32_t ret;
...
int32_t ism330bx_fsm_long_cnt_set(const stmdev_ctx_t *ctx, uint16_t val)
{
  ...
  if (ret == 0)
  {
    ret = ism330bx_write_reg(ctx, ISM330BX_FSM_LONG_COUNTER_L, (uint8_t *)&buff[0], 2);
  }
...
int32_t ism330bx_fsm_long_cnt_get(const stmdev_ctx_t *ctx, uint16_t *val)
{
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_FSM_LONG_COUNTER_L, &buff[0], 2);
  }
...
int32_t ism330bx_fsm_out_get(const stmdev_ctx_t *ctx, ism330bx_fsm_out_t *val)
{
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_FSM_OUTS1, (uint8_t *)val, 8);
  }
                                   ...
                                   ism330bx_fsm_data_rate_t val)
{
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_FSM_ODR, (uint8_t *)&fsm_odr, 1);
  }

  if (ret == 0)
  {
    fsm_odr.fsm_odr = (uint8_t)val & 0x07U;
    ret = ism330bx_write_reg(ctx, ISM330BX_FSM_ODR, (uint8_t *)&fsm_odr, 1);
  }
...
int32_t ism330bx_fsm_long_cnt_timeout_set(const stmdev_ctx_t *ctx, uint16_t val)
{
  ...
  buff[1] = (uint8_t)(val / 256U);
  buff[0] = (uint8_t)(val - (buff[1] * 256U));
  ret = ism330bx_ln_pg_write(ctx, ISM330BX_FSM_LC_TIMEOUT_L, (uint8_t *)&buff[0], 2);
...
int32_t ism330bx_fsm_long_cnt_timeout_get(const stmdev_ctx_t *ctx, uint16_t *val)
{
  ...
  ret = ism330bx_ln_pg_read(ctx, ISM330BX_FSM_LC_TIMEOUT_L, &buff[0], 2);
  if (ret != 0)
  {
    return ret;
  }
...
int32_t ism330bx_fsm_number_of_programs_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  ret = ism330bx_ln_pg_read(ctx, ISM330BX_FSM_PROGRAMS, (uint8_t *)&fsm_programs, 1);
  if (ret == 0)
  {
    fsm_programs.fsm_n_prog = val;
    ret = ism330bx_ln_pg_write(ctx, ISM330BX_FSM_PROGRAMS, (uint8_t *)&fsm_programs, 1);
  }
...
int32_t ism330bx_fsm_start_address_set(const stmdev_ctx_t *ctx, uint16_t val)
{
  ...
  buff[1] = (uint8_t)(val / 256U);
  buff[0] = (uint8_t)(val - (buff[1] * 256U));
  ret = ism330bx_ln_pg_write(ctx, ISM330BX_FSM_START_ADD_L, (uint8_t *)&buff[0], 2);
...
int32_t ism330bx_fsm_start_address_get(const stmdev_ctx_t *ctx, uint16_t *val)
{
  ...
  ret = ism330bx_ln_pg_read(ctx, ISM330BX_FSM_START_ADD_L, &buff[0], 2);
  if (ret != 0)
  {
    return ret;
  }
...
{
  ism330bx_emb_func_en_b_t emb_en_b;
  ism330bx_emb_func_en_a_t emb_en_a;
  int32_t ret;
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_EMB_FUNC_EN_A, (uint8_t *)&emb_en_a, 1);
    ret += ism330bx_read_reg(ctx, ISM330BX_EMB_FUNC_EN_B, (uint8_t *)&emb_en_b, 1);

    if (ret == 0)
    {
      switch (val)
      {
        case ISM330BX_MLC_OFF:
          emb_en_a.mlc_before_fsm_en = 0;
          emb_en_b.mlc_en = 0;
          break;
        case ISM330BX_MLC_ON:
          emb_en_a.mlc_before_fsm_en = 0;
          emb_en_b.mlc_en = 1;
          break;
        case ISM330BX_MLC_ON_BEFORE_FSM:
      ...
      ret += ism330bx_write_reg(ctx, ISM330BX_EMB_FUNC_EN_A, (uint8_t *)&emb_en_a, 1);
      ret += ism330bx_write_reg(ctx, ISM330BX_EMB_FUNC_EN_B, (uint8_t *)&emb_en_b, 1);
    }
  }
...
int32_t ism330bx_mlc_get(const stmdev_ctx_t *ctx, ism330bx_mlc_mode_t *val)
{
  ...
  if (ret == 0)
  {
    ...
    if (ret == 0)
    {
      ...
      {
        *val = ISM330BX_MLC_ON_BEFORE_FSM;
      }
      else
      {
        /* Do nothing */
                                   ...
                                   ism330bx_mlc_data_rate_t val)
{
  ...
  if (ret == 0)
  {
    ret = ism330bx_read_reg(ctx, ISM330BX_MLC_ODR, (uint8_t *)&mlc_odr, 1);
  }

  if (ret == 0)
  {
    mlc_odr.mlc_odr = (uint8_t)val & 0x07U;
    ret = ism330bx_write_reg(ctx, ISM330BX_MLC_ODR, (uint8_t *)&mlc_odr, 1);
  }
...
int32_t ism330bx_mlc_qvar_sensitivity_set(const stmdev_ctx_t *ctx, uint16_t val)
{
  ...
  buff[1] = (uint8_t)(val / 256U);
  buff[0] = (uint8_t)(val - (buff[1] * 256U));
  ret = ism330bx_ln_pg_write(ctx, ISM330BX_MLC_QVAR_SENSITIVITY_L, (uint8_t *)&buff[0], 2);
...
int32_t ism330bx_mlc_qvar_sensitivity_get(const stmdev_ctx_t *ctx, uint16_t *val)
{
  ...
  ret = ism330bx_ln_pg_read(ctx, ISM330BX_MLC_QVAR_SENSITIVITY_L, &buff[0], 2);
                                  ...
                                  ism330bx_xl_offset_mg_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_CTRL9, (uint8_t *)&ctrl9, 1);
  ret += ism330bx_read_reg(ctx, ISM330BX_Z_OFS_USR, (uint8_t *)&z_ofs_usr, 1);
  ret += ism330bx_read_reg(ctx, ISM330BX_Y_OFS_USR, (uint8_t *)&y_ofs_usr, 1);
  ret += ism330bx_read_reg(ctx, ISM330BX_X_OFS_USR, (uint8_t *)&x_ofs_usr, 1);
  ...
  if (ret == 0)
  {
    ret = ism330bx_write_reg(ctx, ISM330BX_Z_OFS_USR, (uint8_t *)&z_ofs_usr, 1);
  }
  if (ret == 0)
  {
    ret = ism330bx_write_reg(ctx, ISM330BX_Y_OFS_USR, (uint8_t *)&y_ofs_usr, 1);
  }
  if (ret == 0)
  {
    ret = ism330bx_write_reg(ctx, ISM330BX_X_OFS_USR, (uint8_t *)&x_ofs_usr, 1);
  }
  if (ret == 0)
  {
    ret = ism330bx_write_reg(ctx, ISM330BX_CTRL9, (uint8_t *)&ctrl9, 1);
...
int32_t ism330bx_fsm_qvar_sensitivity_set(const stmdev_ctx_t *ctx, uint16_t val)
{
  ...
  buff[1] = (uint8_t)(val / 256U);
  buff[0] = (uint8_t)(val - (buff[1] * 256U));
  ret = ism330bx_ln_pg_write(ctx, ISM330BX_FSM_QVAR_SENSITIVITY_L, (uint8_t *)&buff[0], 2);
...
int32_t ism330bx_fsm_qvar_sensitivity_get(const stmdev_ctx_t *ctx, uint16_t *val)
{
  ...
  ret = ism330bx_ln_pg_read(ctx, ISM330BX_FSM_QVAR_SENSITIVITY_L, &buff[0], 2);
  if (ret != 0)
  {
    return ret;
  }
                                   ...
                                   ism330bx_tdm_wclk_bclk_t val)
{
  ...
  ret = ism330bx_read_reg(ctx, ISM330BX_TDM_CFG0, (uint8_t *)&tdm_cfg0, 1);
  if (ret == 0)
  {
    tdm_cfg0.tdm_wclk_bclk_sel = ((uint8_t)val & 0x4U) >> 2;
    tdm_cfg0.tdm_wclk = (uint8_t)val & 0x3U;
    ret = ism330bx_write_reg(ctx, ISM330BX_TDM_CFG0, (uint8_t *)&tdm_cfg0, 1);
  }
...
/**
  ...
  *
  */
int32_t ism330bx_tdm_slot_get(const stmdev_ctx_t *ctx, ism330bx_tdm_slot_t *val)
{
  ism330bx_tdm_cfg0_t tdm_cfg0;
  int32_t ret;
